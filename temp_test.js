...
/* Contact form - graceful submit with Firebase fallback to mailto */
(function () {
  ...
  form.addEventListener('submit', async function (e) {
    ...
    const data = {
      ...
      program:      form.querySelector('#ct-program').value,
      format:       form.querySelector('#ct-format').value,
    ...
    if (!data.firstName || !data.email) {
      errBox.textContent = 'Please fill in your name and email before sending.';
    ...
    try {
      ...
      btn.disabled = false;
      btnText.textContent = 'Checkout';
      errBox.textContent = 'Something went wrong. Please email us directly at corporate@academekey.com';
      errBox.style.display = 'block';
    }
  });
